...
function newYorkCitySalesPrice(product, city) {
  ...
  switch(city){
    case "Amherst": tax = 1.0875; break;
    case "Brooklyn": tax = 1.08875; break;
    case "Buffalo": tax = 1.0875; break;
    case "Cheektowaga": tax = 1.0875; break;
    case "Hempstead": tax = 1.08625; break;
    case "Jamaica": tax = 1.08875; break;
    case "Mount Vernon": tax = 1.08375; break;
    case "New York City": tax = 1.08875; break;
    case "Staten Island": tax = 1.08875; break;
    case "White Plains": tax = 1.08375; break;
    case "Yonkers": tax = 1.08875; break;
    default: tax = 1.08; break;
  }
